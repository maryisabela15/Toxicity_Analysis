...
Annotation goal: Classify the comments into different types of toxicity such as toxic, severe toxic,obscene, threat, insult, identity hate, or clean.

Tools used: I used Python for the cleaning process of the dataset and the creation of the json file. On the other hand, Label Studio was the tool I used for the annotation process
